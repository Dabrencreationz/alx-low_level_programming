...
In this project, we are learning everything on python and its components on a higher level language.
We are given tasks to cover osome of the topics we will be treating in the welcoming stage to learning python language.

Tasks 0 - Write a script that runs a Python script

Task 1 - Write a Shell that runs Python code

Task 2 - Write a Python script that prints exctly "Programming is like building a multilingual puzzle.
